...
Inventory Turnover Ratio, and On-Time Delivery %, reducing manual report generation time by 40%.
  <br><br>
• Created highly Interactive and Dynamic Dashboards using Slicers, Filters, and KPI Cards, enabling stakeholders
to perform real-time multi-level analysis and accelerating decision-making speed by 50%
</p>
